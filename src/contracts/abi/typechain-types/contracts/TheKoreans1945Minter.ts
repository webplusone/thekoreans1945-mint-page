...
export interface TheKoreans1945MinterInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "isListedNFT",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "isListedUser",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "nftForPreMint",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(functionFragment: "owner", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "preMintTime",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "publicMintTime",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setNFTForPreMint",
  ...
  encodeFunctionData(
    functionFragment: "setUserWhitelist",
    values: [PromiseOrValue<string>[], PromiseOrValue<boolean>]
  ): string;
  encodeFunctionData(
...
export type SetNFTWhitelistEvent = TypedEvent<
  [string, boolean],
  SetNFTWhitelistEventObject
>;

export type SetNFTWhitelistEventFilter = TypedEventFilter<SetNFTWhitelistEvent>;

export interface SetUserWhitelistEventObject {
  user: string;
  status: boolean;
}
export type SetUserWhitelistEvent = TypedEvent<
  [string, boolean],
  SetUserWhitelistEventObject
>;

export type SetUserWhitelistEventFilter =
  TypedEventFilter<SetUserWhitelistEvent>;
...
export interface TheKoreans1945Minter extends BaseContract {
  ...
  filters: {
    ...
    "SetNFTWhitelist(address,bool)"(
      nft?: null,
      status?: null
    ): SetNFTWhitelistEventFilter;
    SetNFTWhitelist(nft?: null, status?: null): SetNFTWhitelistEventFilter;

    "SetUserWhitelist(address,bool)"(
      user?: null,
      status?: null
    ): SetUserWhitelistEventFilter;
